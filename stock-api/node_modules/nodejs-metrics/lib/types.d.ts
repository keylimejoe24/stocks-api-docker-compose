...
export declare type labelValues = IDictionary<string | number>;
...
export declare type HistogramConstructor = new (options: IHistogramOptions) => IHistogram;
export declare type CounterConstructor = new (options: ICounterOptions) => ICounter;
export declare type GaugeConstructor = new (options: IGaugeOptions) => IGauge;
...
export declare type IMetric = ICounter | IHistogram | IGauge;
export declare type IMetricsDictionary = IDictionary<IMetric>;
...
export declare type IPromClient = typeof client;
export interface IMetricsTrackerOptions {
    metrics?: IMetricsDictionary;
}
export declare type IExpressMiddlewareSettings = Opts;
export declare type RequestHandlerProvider = (settings: IExpressMiddlewareSettings) => RequestHandler;
export declare type ExpressMiddlewareProvider = (registry: Registry) => RequestHandlerProvider;
